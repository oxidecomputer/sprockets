...
impl ClientHandshake {
    ...
    fn create_finished_msg(
        ...
        // `self.server_identity`, making it safe to unwrap here.
        let server_identity = self.server_identity.take().unwrap();
    ...
    fn handle_identity_verify(
        ...
        if let HandshakeMsgDataV1::IdentityVerify(identity_verify) = msg_data {
            ...
            // Save the server_identity for constructing a `CompletionToken`
