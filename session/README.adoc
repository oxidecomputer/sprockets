...
A user can choose to continue with a session after encrypt or decrypt returns an
error, hoping the problem does not persiste across messages. However, the
suggestion is to terminate.
